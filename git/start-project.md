...
[原文地址](https://github.com/penghcn/start/blob/master/git/start-project.md)
### 开始前
...
基本流程：
    ...
    开发人员 结束feature，合并到develop。若有冲突，跟其他组员沟通后，先rebase 再push到develop
    负责人  创建release分支
    测试人员(或者持续集成工具、负责人、开发人员)基于release代码，发布到测试(或UAT)环境。release分支充分测试、修改结束后，代表可以发布到正式(或灰度)生产环境
